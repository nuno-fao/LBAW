@extends('layouts.app',['title'=>'Review Search Results'])
...
@section('content')
    ...
    <container class="row justify-content-between container-fluid">
        <aside id="user_info" class="bg-light border col-xl-2 col-lg-2 col-8 mx-lg-3 mx-auto d-flex flex-column">
            ...
            <div class="btn-group-vertical">
                ...
                <button type="button"
                    ...
                    <div><span class="fs-6 badge badge-secondary badge-pill">{{ $reviews_count }}</span></div>
                </button>
            </div>
        </aside>
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="d-flex">
                @if ($reviews_count > 0)
                    <div id="users_section" class=" d-flex justify-content-between flex-column mx-auto">
                        @each('partials.review_result',$reviews,'review')
                    </div>
                @else
